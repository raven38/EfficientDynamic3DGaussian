...
For the actual frame rate.



https://github.com/raven38/EfficientDynamic3DGaussian/assets/4375159/7195c8d8-4a61-4d8f-b7d9-1fc90e5779ea


## Overview

This repo is implemented upon the [Gaussian Splatting repo](https://github.com/graphdeco-inria/gaussian-splatting).
...
To run the optimization and evaluation, simply use
```shel
bash scripts/process_dnerf.sh output/dnerf_all
```
