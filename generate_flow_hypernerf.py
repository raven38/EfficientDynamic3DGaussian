...
if __name__ == '__main__':
    ...
    images = glob.glob(os.path.join(input_path, 'left*.png')) + glob.glob(os.path.join(input_path, 'left*.jpg'))
    run(args, images, input_path, output_path, output_img_path)
    images = glob.glob(os.path.join(input_path, 'right*.png')) + glob.glob(os.path.join(input_path, 'right*.jpg'))
    run(args, images, input_path, output_path, output_img_path)
